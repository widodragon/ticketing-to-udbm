                    ...
                    <Box display="flex" flexDirection="column">
                        ...
                        <Stack direction={["column", "row"]} gap={2} alignItems={["end", "inherit"]} justifyContent="space-between" mt={5}>
                            ...
                            <Box sx={{ display: "flex", alignItems: "center", gap: 1, justifyContent: "center" }}>
                                ...
                                <Button disabled={!ouCode || !periode ? true : false} onClick={() => handleGetListGrading({ limitDt: 25, offsetDt: 0, ouCodeValue: [ouCode.value || ""] })} startIcon={<SearchIcon />} variant="contained">Filter</Button>
                            </Box>
                        </Stack>
